...
public class UpdateCategoryUseCaseTest {
    ...
    @Test
    public void givenAValidCommand_whenCallsUpdateCategory_shouldReturnInactiveCategoryId(){
        final var aCategory =
                Category.newCategory("filn", null, true);
    ...
    public void givenAnInvalidName_whenCallsUpdateCategory_thenShouldReturnDomainException(){
        ...
        Mockito.verify(categoryGateway, VerificationModeFactory.times(0)).update(any());
    }
