package com.fullcycle.admin.catalogo.domain.application.category;
...
public class CategoryTest {
    ...
    public void GivenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError(){
        final var expectedName = """
                O incentivo ao avanço tecnológico, assim como a expansão dos mercados mundiais faz parte de um processo de gerenciamento do remanejamento
                dos quadros funcionais. Por conseguinte, o desenvolvimento contínuo de distintas formas de atuação deve passar por modificações independentemente das direções preferenciais no 
                """;
        final var expectedErrorCount = 1;
        final var expectedErrorMessage = "'name' must be between 3 and 255 characters";
        final var expectedDescription = "A categoria mais assistida";
